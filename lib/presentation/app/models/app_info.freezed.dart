...
mixin _$AppInfo {
 ...
 String get appName; String get packageName; String get version; int get buildNumber;
...
@useResult
$Res call({
 String appName, String packageName, String version, int buildNumber
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String appName,  String packageName,  String version,  int buildNumber)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppInfo() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String appName,  String packageName,  String version,  int buildNumber)  $default,) {final _that = this;
switch (_that) {
case _AppInfo():
return $default(_that.appName,_that.packageName,_that.version,_that.buildNumber);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String appName,  String packageName,  String version,  int buildNumber)?  $default,) {final _that = this;
switch (_that) {
case _AppInfo() when $default != null:
return $default(_that.appName,_that.packageName,_that.version,_that.buildNumber);case _:
  return null;
...
class _AppInfo extends AppInfo {
  const _AppInfo({this.appName = 'MyEgo', this.packageName = 'vn.kaizengo.ego', this.version = '1.0.0', this.buildNumber = 0}): super._();
  

@override@JsonKey() final  String appName;
@override@JsonKey() final  String packageName;
@override@JsonKey() final  String version;
@override@JsonKey() final  int buildNumber;
